...
const Installation = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      try {
        ...
        console.error("Error parsing installedApps from localStorage:", error);
        setInstalledApps([]);
      }
      setLoading(false);
    }, 500);
  ...
  return (
    <div className="py-10 px-4 sm:px-6 md:px-10 lg:px-20 space-y-10 bg-gray-50">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto text-center sm:text-left">
                <img
                  ...
                  onError={() =>
                    console.log(`Failed to load image for ${app.title}`)
                  }
                />
                  ...
                  <div className="flex flex-wrap justify-center sm:justify-start gap-3 text-gray-600 text-sm sm:text-base items-center">
                    <div className="flex items-center gap-1">
                      <img
                        ...
                        onError={() =>
                          console.log("Download image failed to load")
                        }
                      />
                    ...
                    <div className="flex items-center gap-1">
                      <img
                        ...
                        className="h-4 w-4 sm:h-5 sm:w-5"
                        onError={() =>
                          console.log("Rating image failed to load")
                        }
                      />
